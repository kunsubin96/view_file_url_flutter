...
class _CupertinoControlsState extends State<CupertinoControls>
  ...
  Widget build(BuildContext context) {
    if (_latestValue.hasError) {
      return mediaController.errorBuilder != null
          ? mediaController.errorBuilder!(
              context,
                ...
                children: <Widget>[
                  ...
                  if (_subtitleOn)
                    Transform.translate(
                      ...
                      child: _buildSubtitles(mediaController.subtitle!),
                    ),
                ...
                child: mediaController.isLive
                    ...
                    : Row(
                        children: <Widget>[
                          ...
                          if (mediaController.allowPlaybackSpeedChanging)
  ...
  Widget _buildTopBar(
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          if (mediaController.allowFullScreen)
            _buildExpandButton(
                backgroundColor, iconColor, barHeight, buttonPadding),
          const Spacer(),
          if (mediaController.allowMuting)
