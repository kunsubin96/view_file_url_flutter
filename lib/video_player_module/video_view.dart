...
import 'package:view_file_url_flutter/video_player_module/player_with_controls.dart';
...
typedef VideoViewRoutePageBuilder = Widget Function(
  ...
  _MediaControllerProvider controllerProvider,
);

/// A Video Player with Material and Cupertino skins.
///
/// `video_player` is pretty low level. Video wraps it in a friendly skin to
/// make it easy to use!
...
class VideoViewState extends State<VideoView> {
  ...
  Widget build(BuildContext context) {
    return _MediaControllerProvider(
  ...
  Widget _fullScreenRoutePageBuilder(
    ...
    final controllerProvider = _MediaControllerProvider(
      controller: widget.controller,
      child: ChangeNotifierProvider<PlayerNotifier>.value(
        value: notifier,
        builder: (context, w) => const PlayerWithControls(),
...
/// The MediaController is used to configure and drive the Video View
...
///
/// In addition, you can listen to the VideoController for presentational
...
class MediaController extends ChangeNotifier {
  ...
  static MediaController of(BuildContext context) {
    final chewieControllerProvider = context
        .dependOnInheritedWidgetOfExactType<_MediaControllerProvider>()!;
...
class _MediaControllerProvider extends InheritedWidget {
  const _MediaControllerProvider({
    Key? key,
    required this.controller,
  ...
  @override
  bool updateShouldNotify(_MediaControllerProvider old) =>
